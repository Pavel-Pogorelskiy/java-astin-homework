 ...
 * {@code MyArrayList}. It contains quicksort algorithm that operate on {@code MyArrayList}
 * and modify it.
 *
...
public class Sorts {
    ...
    private static <T> void swap(List<T> list, int firstNumber, int secondNumber) {
